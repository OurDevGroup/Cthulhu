...
exports.createFolder = function(serverOptions, folder, callback) {
    ...
    var opt = {
        ...
        method: 'MKCOL',
        ca: serverOptions.servercert ? fs.readFileSync(utils.rootDir('certs') + serverOptions.servercert) : null,
        cert: serverOptions.privatekey ? fs.readFileSync(utils.rootDir('certs') + serverOptions.privatekey.certpath) : null,
        key: serverOptions.privatekey ? fs.readFileSync(utils.rootDir('certs') + serverOptions.privatekey.keypath) : null,
        passphrase: serverOptions.privatekey ? utils.decrypt(serverOptions.privatekey.password, serverOptions.username) : null,
        port: 443,
